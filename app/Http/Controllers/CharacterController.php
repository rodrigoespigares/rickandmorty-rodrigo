...
class CharacterController extends Controller
{
     ...
     * @group Personajes
     * 
     * @queryParam name string Nombre del personaje
     * @queryParam species string Nombre de especie
     * @queryParam gender string Nombre de género
     * @queryParam type string Nombre de tipo
     *
     * @response 200 {
     *    "info": {
     *        "count": 826,
     ...
     * @group Personajes
     * 
     * @queryParam id integer Id del personaje
     * 
     * @response 200 {
     *    "id": integer,
     *    "name": string,
